...
function core(out,inp,k,c,h) {
  ...
  //c/onsole.log("core -> "+JSON.stringify(out));
}

function crypto_core_salsa20(out,inp,k,c) {
  core(out,inp,k,c,false);
  
  //c/onsole.log("crypto_core_salsa20 -> "+JSON.stringify(out));
...
function crypto_core_hsalsa20(out,inp,k,c) {
  ...
  //c/onsole.log("crypto_core_hsalsa20 -> "+JSON.stringify(out));
...
function car25519(o) {
  var c;
  var i;
  //c/onsole.log("car25519 pre -> "+JSON.stringify(o));
  ...
  //c/onsole.log("car25519 -> "+JSON.stringify(o));
...
function sel25519(p, q, b) {
  ...
  //c/onsole.log("sel25519 -> "+JSON.stringify(p));
...
function pack25519(o, n) {
  ...
  //c/onsole.log("pack25519 -> "+JSON.stringify(o));
...
function M(o, a, b) {
  ...
  //c/onsole.log("M -> "+JSON.stringify(o));
}
...
function inv25519(o, i) {
  ...
  //c/onsole.log("inv25519 -> "+JSON.stringify(o));
...
function crypto_scalarmult(q, n, p) {
  ...
  //c/onsole.log("crypto_scalarmult -> "+JSON.stringify(q));
...
function crypto_box_beforenm(k, y, x) {
  ...
  //c/onsole.log("crypto_box_beforenm -> "+JSON.stringify(s));
...
function scalarmult(p, q, s) {
  ...
  //c/onsole.log("scalarmult -> "+JSON.stringify(p));
}
